...
exports.calculate = function(pass) {
	...
	// temp, replace with actual user location data
	coords = observer_coords_ecf;
	
	//  Now to propagate a satellite's position and velocity.
	var satrec                  = satellite.twoline2satrec (pass.TLE_LINE1, pass.TLE_LINE2);
	var now											= moment();
	var epochTime								= moment(pass.EPOCH);
	var time_since_tle_epoch		= now.subtract(epochTime);
	var position_and_velocity   = satellite.sgp4 (satrec, time_since_tle_epoch.minutes());
